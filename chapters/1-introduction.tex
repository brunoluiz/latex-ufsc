...
\begin{itemize}
  ...
  \item Explorar e implementar protocolos de comunicação de \ac{EVSE}
  \item Desenvolver e aprender novas habilidades de engenharia de \textit{software}
  \item Implementar um \textit{software} para controle de uma \ac{EVSE}
\end{itemize}
