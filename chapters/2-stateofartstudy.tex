...
\label{stateofart}
  ...
  \label{stateofart:ocpp}
    ...
    As requisições da versão 1.5 podem ser via \textit{\ac{SOAP}} ou \textit{WebSocket}, enquanto a versão 1.6 já adiciona suporte a \textit{JSON}. A versão 2.0, em desenvolvimento, tem em mente a padronização do protocolo e compatibilidade com versões anteriores.
